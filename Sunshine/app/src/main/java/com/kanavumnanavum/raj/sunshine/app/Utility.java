...
public class Utility
{
    ...
    public static String getFormatTemperature(Context context, double temperature, boolean isMetric)
    {
        double temp;
        if(!isMetric)
        {
    ...
    public static String getPreferredLocation(Activity activity)
    {
        ...
        String defaultLocation = sharedPref.getString("location", "08536");
